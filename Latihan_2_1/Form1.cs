...
namespace Latihan_2_1
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            {
                if (awalTahun.DayOfWeek.ToString() == "Sunday" || awalTahun.DayOfWeek.ToString() == "Saturday")
                {
                    monthCalendar1.AddBoldedDate(awalTahun);
                }
                awalTahun = awalTahun.AddDays(1);
            }
            monthCalendar1.AddAnnuallyBoldedDate(new DateTime(1996, 4, 5));
        }
